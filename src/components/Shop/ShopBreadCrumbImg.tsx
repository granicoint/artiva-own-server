                ...
                <div className="breadcrumb-main bg-linear overflow-hidden">
                    <div className="container lg:pt-[134px] pt-24 pb-10 relative">
                        ...
                        <div className="bg-img absolute top-2 -right-6 max-lg:bottom-0 max-lg:top-auto w-1/3 max-lg:w-[26%] z-[0] max-sm:w-[45%]">
                            <Image src={"/images/slider/bg1-1.png"} width={1000} height={1000} alt="" className="" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="list-product-block relative">
                        <div className="filter-heading flex items-center justify-between gap-5 flex-wrap">
                            <div className="left flex has-line items-center flex-wrap gap-5">
                                <div className="filter-sidebar-btn flex items-center gap-2 cursor-pointer" onClick={handleOpenSidebar}>
                        ...
                        <div className={`sidebar style-dropdown bg-white grid md:grid-cols-4 grid-cols-2 md:gap-[30px] gap-6 ${openSidebar ? "open" : ""}`}>
                                ...
                                <div className="list-type mt-4">
                                    {["t-shirt", "dress", "top", "swimwear", "shirt", "underwear", "sets", "accessories"].map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="text-secondary2">({data.filter((dataItem) => dataItem.type === item && dataItem.category === "fashion").length})</div>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="filter-price mt-8">
                                    ...
                                    <Slider range defaultValue={[0, 100]} min={0} max={100} onChange={handlePriceChange} className="mt-5" />
                                        ...
                                        <div key={index} className="brand-item flex items-center justify-between">
                                            <div className="left flex items-center cursor-pointer">
                                                <div className="block-input">
                                                    <input type="checkbox" name={item} id={item} checked={brand === item} onChange={() => handleBrand(item)} />
                                            ...
                                            <div className="text-secondary2">({data.filter((dataItem) => dataItem.brand === item && dataItem.category === "fashion").length})</div>
                                        </div>
                                    ))}
                                </div>
                            </div>
