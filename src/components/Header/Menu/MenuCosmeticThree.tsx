                                            ...
                                            <div className="flex justify-between py-8">
                                                <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                    <div className="nav-item">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("cosmetic")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                    ...
                                                    <div className="nav-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("nail")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Nail Polish
                                                                </div>
                                                            </li>
                                                            <li>
                                            ...
                                            <div className="flex justify-between py-8">
                                                ...
                                                <div className="recent-product pl-2.5 basis-1/3">
                                                    ...
                                                    <div className="list-product hide-product-sold  grid grid-cols-2 gap-5 mt-3">
                                                        {productData
                                                            .filter((item) => item.action === "add to cart" && item.category === "cosmetic")
                                                            .slice(0, 2)
                                                            .map((prd, index) => (
