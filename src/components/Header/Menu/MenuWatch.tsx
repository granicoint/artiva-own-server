                                            ...
                                            <div className="flex justify-between py-8">
                                                <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("watch")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Starting From 50% Off
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("apple")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Apple Watch
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("fitness")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    fitness Watch
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("sport")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Sport Watch
                                                                </div>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("classic")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    classic watch
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("luxury")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    luxury watch
                                                                </div>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("watch")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("smart")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    smart Watch
                                                                </div>
                                                            </li>
                                                            <li>
                                            ...
                                            <div className="flex justify-between py-8">
                                                ...
                                                <div className="recent-product pl-2.5 basis-1/3">
                                                    ...
                                                    <div className="list-product hide-product-sold  grid grid-cols-2 gap-5 mt-3">
                                                        {productData
                                                            .filter((item) => item.action === "add to cart" && item.category === "watch")
                                                            .slice(0, 2)
                                                            .map((prd, index) => (
