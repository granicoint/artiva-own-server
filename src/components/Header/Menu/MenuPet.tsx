                    ...
                    <div className="top-nav-menu-main flex items-center justify-between h-full">
                        <div className="left flex items-center h-full">
                            <div className="menu-department-block relative h-full">
                                ...
                                <div className={`sub-menu-department absolute top-[44px] left-0 right-0 h-max bg-white rounded-b-2xl ${openShopDepartmentPopup ? "open" : ""}`}>
                                    ...
                                    <div className="item block">
                                        <Link href={"/shop/breadcrumb-img"} className="caption1 py-4 px-5 whitespace-nowrap block">
                                            Pet Services
                                        </Link>
                                    </div>
                                </div>
                                                ...
                                                <div className="flex justify-between py-8">
                                                    <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                        <div className="nav-item" data-nosnippet>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <div onClick={() => handleCategoryClick("pet")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                ...
                                                                <li>
                                                                    <div onClick={() => handleTypeClick("pet")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                        Pet Sale Off
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div onClick={() => handleTypeClick("food")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                        Pet Food
                                                                    </div>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div className="nav-item" data-nosnippet>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <div onClick={() => handleTypeClick("outfit")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                        Dog Outfit
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <div onClick={() => handleCategoryClick("pet")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                        View All
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div className="flex justify-between py-8">
                                                    ...
                                                    <div className="recent-product pl-2.5 basis-1/3">
                                                        ...
                                                        <div className="list-product hide-product-sold  grid grid-cols-2 gap-5 mt-3">
                                                            {productData
                                                                .filter((item) => item.action === "add to cart" && item.category === "pet")
                                                                .slice(0, 2)
                                                                .map((prd, index) => (
                        ...
                        <div className="right flex items-center gap-1 max-[1240px]:hidden">
                            <div className="text-button">
                                Limited Time Offer: <span className="text-red">Free shipping</span> on all orders over $50
                            </div>
                        </div>
                    </div>
                </div>
