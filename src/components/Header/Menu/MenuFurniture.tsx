                                                ...
                                                <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("table")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("chair")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("lighting")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                            ...
                                            <div className="flex justify-between py-8">
                                                ...
                                                <div className="recent-product pl-2.5 basis-1/3">
                                                    ...
                                                    <div className="list-product hide-product-sold  grid grid-cols-2 gap-5 mt-3">
                                                        {productData
                                                            .filter((item) => item.action === "add to cart" && item.category === "furniture")
                                                            .slice(0, 2)
                                                            .map((prd, index) => (
                                                ...
                                                <div className="nav-link grid grid-cols-2 gap-5 gap-y-6">
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("bracelet")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Chain Bracelet
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("necklace")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Necklace Charms
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("ring")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Engagement Ring
                                                                </div>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("necklace")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("bracelet")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("ring")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
