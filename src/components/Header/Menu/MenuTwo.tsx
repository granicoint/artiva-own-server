                                ...
                                <li className="h-full relative">
                                    ...
                                    <div className="sub-menu absolute py-3 px-5 -left-10 w-max grid grid-cols-4 gap-5 bg-white rounded-b-xl">
                                        <ul>
                                            ...
                                            <li>
                                                <Link href="/homepages/fashion2" className={`text-secondary duration-300 ${pathname === "/homepages/fashion2" ? "active" : ""}`}>
                                                    Home Fashion 2
                                                </Link>
                                            </li>
                                            <li>
                                            ...
                                            <div className="flex justify-between py-8">
                                                <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleGenderClick("men")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Starting From 50% Off
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("outerwear")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Outerwear | Coats
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("sweater")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Sweaters | Cardigans
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("shirt")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Shirt | Sweatshirts
                                                                </div>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("top")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Top | Overshirts
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("t-shirt")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    T-shirts | Clothes
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("swimwear")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Swimwear | Underwear
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("fashion")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("face")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Faces Skin
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("eye")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Eyes Makeup
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("lip")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Lip Polish
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("hair")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Hair Care
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("cosmetic")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("candle")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Cented Candle
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("drinks")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Health Drinks
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("clothes")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Yoga Clothes
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("mats")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Yoga Equipment
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("yoga")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleGenderClick("women")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Starting From 60% Off
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("dress")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Dresses | Jumpsuits
                                                                </div>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("accessories")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Accessories | Jewelry
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleGenderClick("women")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("bed")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Kids Bed
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("toy")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Boy{String.raw`'s`} Toy
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("blanket")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Baby Blanket
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("clothing")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Newborn Clothing
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("toys-kid")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("furniture")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Furniture | Decor
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("table")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Table | Living Room
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("chair")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Chair | Work Room
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("lighting")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Lighting | Bed Room
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("furniture")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div className="nav-link basis-2/3 flex justify-between pr-12">
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <Link href={"/checkout"} className={`link text-secondary duration-300 ${pathname === "/checkout" ? "active" : ""}`}>
                                                                    Checkout
                                                                </Link>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <Link href={"/wishlist"} className={`link text-secondary duration-300 ${pathname === "/wishlist" ? "active" : ""}`}>
                                                                    Wish List
                                                                </Link>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <Link href={"/cart"} className={`link text-secondary duration-300 ${pathname === "/cart" ? "active" : ""}`}>
                                                                    Shopping Cart
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link href={"/login"} className={`link text-secondary duration-300 ${pathname === "/login" ? "active" : ""}`}>
                                                                    Login/Register
                                                                </Link>
                                                            </li>
                                                            <li>
                            ...
                            <div className="list-nav mt-6">
                                <ul>
                                                ...
                                                <div className="nav-link grid grid-cols-2 gap-5 gap-y-6">
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleGenderClick("men")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div className="">
                                                    <div className="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                        ...
                                                        <div className="nav-item" data-nosnippet>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <Link href={"/wishlist"} className={`text-secondary duration-300 ${pathname === "/wishlist" ? "active" : ""}`}>
                                                                        Wish List
                                                                    </Link>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <Link href={"/cart"} className={`text-secondary duration-300 ${pathname === "/cart" ? "active" : ""}`}>
                                                                        Shopping Cart
                                                                    </Link>
                                                                </li>
                                                                <li>
                                                                    <Link href={"/login"} className={`text-secondary duration-300 ${pathname === "/login" ? "active" : ""}`}>
                                                                        Login/Register
                                                                    </Link>
                                                                </li>
                                                                <li>
                                    ...
                                    <li className={`${openSubNavMobile === 4 ? "open" : ""}`} onClick={() => handleOpenSubNavMobile(4)}>
                                        ...
                                        <div className="sub-nav-mobile">
                                            <div className="back-btn flex items-center gap-3" onClick={() => handleOpenSubNavMobile(4)}>
                                                <Icon.CaretLeft />
                                                Back
                                            </div>
                                            <div className="list-nav-item w-full pt-3 pb-12">
                                    ...
                                    <li className={`${openSubNavMobile === 5 ? "open" : ""}`} onClick={() => handleOpenSubNavMobile(5)}>
                                        ...
                                        <div className="sub-nav-mobile">
                                            <div className="back-btn flex items-center gap-3" onClick={() => handleOpenSubNavMobile(5)}>
                                                <Icon.CaretLeft />
                                                Back
                                            </div>
