                    ...
                    <div className="container mx-auto h-full">
                        <div className="header-main flex items-center justify-between h-full">
                            ...
                            <Link href={"/"} className="flex items-center">
                                <div className="heading4 text-white">Artiva</div>
                            </Link>
                        ...
                        <div className="top-nav-menu-main flex items-center justify-between h-full">
                            <div className="left flex items-center h-full">
                                <div className="menu-department-block relative h-full">
                                    <div className="menu-department-btn relative flex items-center sm:gap-24 gap-4 h-full w-fit cursor-pointer" onClick={handleSubMenuDepartment}>
                                    ...
                                    >
                                        <Link href="/shop/breadcrumb-img" className="item py-3 whitespace-nowrap border-b border-line w-full flex items-center justify-between">
                                        ...
                                        <Link href="/shop/breadcrumb-img" className="item py-3 whitespace-nowrap w-full flex items-center justify-between">
                                            <span className="flex items-center gap-2">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <Link
                                                            ...
                                                            className={`text-secondary duration-300 ${pathname === "/homepages/marketplace" ? "active" : ""}`}
                                                        >
                                                            Home Marketplace
                                                        </Link>
                                                    </li>
                                                        ...
                                                        <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                            <div className="nav-item" data-nosnippet>
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <div onClick={() => handleTypeClick("fruit")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                            organic fruits
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div onClick={() => handleTypeClick("meat")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                            organic meat
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                            ...
                                                            <div className="nav-item" data-nosnippet>
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <div onClick={() => handleTypeClick("fruit")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                            View All
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <div className="nav-item" data-nosnippet>
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <div onClick={() => handleTypeClick("meat")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                            View All
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                    ...
                                                    <div className="flex justify-between py-8">
                                                        ...
                                                        <div className="recent-product pl-2.5 basis-1/3">
                                                            ...
                                                            <div className="list-product hide-product-sold  grid grid-cols-2 gap-5 mt-3">
                                                                {productData
                                                                    .filter((item) => item.action === "add to cart" && item.category === "organic")
                                                                    .slice(0, 2)
                                                                    .map((prd, index) => (
                            ...
                            <div className="list-nav mt-6">
                                <ul>
                                    ...
                                    <li className={`${openSubNavMobile === 2 ? "open" : ""}`} onClick={() => handleOpenSubNavMobile(2)}>
                                        <Link href={"#!"} className="text-xl font-semibold flex items-center justify-between mt-5">
                                            Features
                                            <span className="text-right">
                                                <Icon.CaretRight size={20} />
                                            </span>
                                            ...
                                            <div className="list-nav-item w-full pt-3 pb-12">
                                                <div className="nav-link grid grid-cols-2 gap-5 gap-y-6">
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div onClick={() => handleCategoryClick("organic")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    Starting From 50% Off
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div onClick={() => handleTypeClick("vegetables")} className={`link text-secondary duration-300 cursor-pointer`}>
                                                                    organic vegetables
                                                                </div>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div className="nav-item" data-nosnippet>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div onClick={() => handleTypeClick("vegetables")} className={`link text-secondary duration-300 view-all-btn`}>
                                                                    View All
                                                                </div>
                                                            </li>
                                                        </ul>
